package me.lca.skush.utils.fontRenderer;
...
public class TTFFontRenderer {
    ...
    public final int drawString(String text, double x, double y, int color) {
        return renderString(text,(float) x, (float) y, color, false);
    }
    ...
    public final int drawCenteredString(String text, double x, double y, int color) {
        ...
        return renderString(text, (float) x - getWidth(text) / 2, (float)y /*- getHeight(text) / 2*/, color, false);
    }
    ...
    public final void drawStringWithShadow(final String text, final double x, final double y, final int color) {
        drawStringWithShadow(text, (float) x, (float) y, color);
    }

    public final void drawStringWithShadow(final String text, final double x, final double y, final Color color) {
