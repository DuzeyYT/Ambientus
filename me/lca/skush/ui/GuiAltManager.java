...
public class GuiAltManager extends GuiScreen {
    ...
    public GuiAltManager(GuiScreen event) {
        parentScreen = event;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (final AltTypes slot : AltsSaver.AltTypeList) {
            if (slot != null) {
                ...
                Ambien.INSTANCE.fontManager.ambienFont.drawStringWithShadow(slot.EmailName, width / 3,
                        boxY + i1 + 20, 0xffbeff11);
//				Ambien.INSTANCE.fontManager.ambienFont.drawStringWithShadow(slot.PWName,
//						width / 2 + Ambien.INSTANCE.fontManager.ambienFont.getStringWidth(slot.EmailName) + 2,
//						boxY + i1 + 20, 0xffbeff11);
